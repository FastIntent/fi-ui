...
describe('Divider Component', () => {
  it('renders as horizontal by default', () => {
    ...
    expect(container.firstChild).toHaveClass('fi-divider');
    expect(container.firstChild).toHaveClass('fi-divider-horizontal');
  });

  it('renders as vertical when type is vertical', () => {
    const { container } = render(<Divider type="vertical" />);
    expect(container.firstChild).toHaveClass('fi-divider-vertical');
  });
